  ...
  var kkpager2 = {
      ...
      generPageHtml : function(config,enforceInit){
        ...
        if(this.isShowPrePageBtn){
          if(this.hasPrv){
            str_prv = '<a data-page="'+this.prv+'" title="'
        ...
        if(this.isShowNextPageBtn){
          if(this.hasNext){
            str_next = '<a data-page="'+this.next+'" title="'
        ...
        if(this.isShowLastPageBtn){
          if(this.hasNext){
            str_last = '<a data-page="'+this.total+'" title="'
        ...
        if(this.isGoPage){
          gopage_info = '&nbsp;'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
            '<input type="button" id="'+this.gopageButtonId+'" onclick="kkpager2.gopage()" value="'
              +this.lang.gopageButtonOkText+'" />'+
            '<input type="text" id="'+this.gopageTextboxId+'" onfocus="kkpager2.focus_gopage()"  onkeypress="return kkpager2.keypress_gopage(event);"   onblur="kkpager2.blur_gopage()" value="'+this.next+'" /></span>'+this.lang.gopageAfterText;
        }
        ...
        if(this.total <= 8){
          ...
          if(this.pno <= 5){
            ...
            str += '<a data-page="1" title="'
              +this.lang.buttonTipBeforeText + '1' + this.lang.buttonTipAfterText+'">1</a>';
            str += '<a data-page="2" title="'
        ...
        $("#"+this.pagerid+" a").on("click",function() {
          if($(this).data("page")){
            kkpager2._clickHandler($(this).data("page"));
          }
        });
      },
      //分页按钮控件初始化
      ...
      _getHandlerStr : function(n){
        if(this.mode == 'click'){
          return 'href="'+this.getHref(n)+'" onclick="return kkpager2._clickHandler('+n+')"';
        }
        //link模式，也是默认的
