...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","easyui_progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
(function($){
function init(_1dc){
$(_1dc).addClass("easyui_progressbar");
$(_1dc).html("<div class=\"easyui_progressbar-text\"></div><div class=\"easyui_progressbar-value\"><div class=\"easyui_progressbar-text\"></div></div>");
...
var opts=$.data(_1df,"easyui_progressbar").options;
var bar=$.data(_1df,"easyui_progressbar").bar;
if(_1e0){
opts.width=_1e0;
}
bar._size(opts);
bar.find("div.easyui_progressbar-text").css("width",bar.width());
bar.find("div.easyui_progressbar-text,div.easyui_progressbar-value").css({height:bar.height()+"px",lineHeight:bar.height()+"px"});
};
$.fn.easyui_progressbar=function(_1e1,_1e2){
if(typeof _1e1=="string"){
var _1e3=$.fn.easyui_progressbar.methods[_1e1];
if(_1e3){
...
_1e1=_1e1||{};
return this.each(function(){
var _1e4=$.data(this,"easyui_progressbar");
if(_1e4){
$.extend(_1e4.options,_1e1);
}else{
_1e4=$.data(this,"easyui_progressbar",{options:$.extend({},$.fn.easyui_progressbar.defaults,$.fn.easyui_progressbar.parseOptions(this),_1e1),bar:init(this)});
}
$(this).easyui_progressbar("setValue",_1e4.options.value);
_1de(this);
});
};
$.fn.easyui_progressbar.methods={options:function(jq){
return $.data(jq[0],"easyui_progressbar").options;
},resize:function(jq,_1e5){
return jq.each(function(){
_1de(this,_1e5);
});
},getValue:function(jq){
return $.data(jq[0],"easyui_progressbar").options.value;
...
return jq.each(function(){
var opts=$.data(this,"easyui_progressbar").options;
var text=opts.text.replace(/{value}/,_1e6);
var _1e7=opts.value;
opts.value=_1e6;
$(this).find("div.easyui_progressbar-value").width(_1e6+"%");
$(this).find("div.easyui_progressbar-text").html(text);
if(_1e7!=_1e6){
opts.onChange.call(this,_1e6,_1e7);
}
});
}};
$.fn.easyui_progressbar.parseOptions=function(_1e8){
return $.extend({},$.parser.parseOptions(_1e8,["width","height","text",{value:"number"}]));
};
$.fn.easyui_progressbar.defaults={width:"auto",height:22,value:0,text:"{value}%",onChange:function(_1e9,_1ea){
}};
})(jQuery);
(function($){
function init(_1eb){
...
bar.easyui_progressbar({text:opts.text});
win.window("resize");
if(opts.interval){
win[0].timer=setInterval(function(){
var v=bar.easyui_progressbar("getValue");
v+=10;
if(v>100){
v=0;
}
bar.easyui_progressbar("setValue",v);
},opts.interval);
}
return win;
}};
